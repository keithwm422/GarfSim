...
//  const double pressure = 1 * AtmosphericPressure; // in torr- we were at 14.6 psi (1 psi = 51.7149 torr)
  ...
  ingasfilename << "/home/kmcbride/garfield/GarfSim/Garfield/FlightGasFiles/Flight2024_midway_B_0_Tesla_P_755.865_T_293.15_multiE_90CO2_10Ar.gas";
...
//  gas->LoadGasFile("Flight2024_Bon_P_755.865_T_298.15_.gas");
  ...
  outputfilename << "isochronGenerator_multi_histo_xmin_" << x_i << "_xmax" << max_x_i << "_maxe_"<< max_electrons << "_.txt";
  ...
  for (int iplane=0;iplane<2;iplane++){
    for(int ipad=0;ipad<nstrips_per_PCB;ipad++){
      ...
      for(int wire_in_pad=0;wire_in_pad<num_wires_for_rep;wire_in_pad++){
        ...
        cmp->AddWire(x_delt,y,0.1*pad_r,v,"T");
        cmp->AddWire(leftx_delt,y,0.1*pad_r,v,"T");
