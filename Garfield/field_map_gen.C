...
int main(int argc, char * argv[]) {
  ...
  const double max_y_i=1.0, max_x_i=0.5, stepy=0.1,stepx=0.025, min_y_i=-1.0;
  const double x_i=-0.5, y_i=min_y_i, z_i=0.0, t_i=0, e_i=0, dx_i=0, dy_i=0, dz_i=0; // -300e-4+rAnode+100e-4 , 2.4 ,0 ,0 (don't forget the stagger in x! add extra 0.03)
...
//    for(int iw=0;iw<68;iw++){
  ...
  if (false) {
    fieldView.PlotProfile(-7.5, -2.4, 0.0,7.5 , 2.5, 0., "ex");
  } else {
