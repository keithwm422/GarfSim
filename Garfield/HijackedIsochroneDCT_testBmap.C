...
int main(int argc, char * argv[]) {
  ...
  // Setup the gas
  /// KEITH ADD mgabolz generation here to cover the example solenoid bfield values and see if inline this generates isochrones
...
//  const double rPotential= 175e-4;
  ...
  */
  ...
  cmpB->SetCylindricalCoordinates();
  cmpB->LoadMagneticField("solenoid.txt", "XZ");
