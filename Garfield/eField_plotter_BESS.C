...
*/
  ...
  */
  ...
  cmp->AddPlaneX(-8.63,-10300,"cP1"); 
  cmp->AddPlaneX(8.63,-10300,"cP2");



  float v=0;
  float tweak=0;
  float drift_dist_max=8.63*1.0;
  ...
  if (true) {
    ...
    fieldView.PlotProfile(-8.63, zpos/10.0, 0.0,8.63, zpos/10.0, 0.0, "ex"); // this line is for a sense wire region near (0,28.4,0).  // divide by 10.0 to get into centimeters
