...
#[2] j is now wire ID from 0 to 71, there is also a temp arg and a b-field arg
for j in {71..71..2} 
do
  check
  execute "./BON_iso_gen_parsedbysensewire $j 299 1 > BON_iso_persensewire_redirects/simout_299_1_$j.txt 2>&1 &"
  echo $j
  #execute "./BOFF_iso_gen_parsedbysensewire 6 299 0 > parallelhist_suck.txt 2>&1"
done
wait
