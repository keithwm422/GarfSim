...
//  const double rPotential= 175e-4;
  ...
  */
  ...
  if(!oldWay) TF1name << "Tilt_" << std::fixed << std::setprecision(0) << thistilt << "um_newdiameters.root";
  else  TF1name << "Tilt_" << std::fixed << std::setprecision(0) << thistilt << "um_electrode.root";
