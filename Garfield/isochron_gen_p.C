...
int main(int argc, char * argv[]) {
  ...
  const double max_y_i=1.0, max_x_i=7.5, stepy=0.1,stepx=0.25, min_y_i=-1.0;
  ...
  std::ofstream outputfile("isochron_BON_T303_full_cmpB_multiwire_parallel.txt",std::ios_base::app);
...
//    for(int iw=0;iw<68;iw++){
  ...
  for(int ix=0;ix<size_of_x_grid;ix++){
    ...
    outputfile.open("isochron_BON_T303_full_cmpB_multiwire_parallel.txt",std::ios_base::app);
    while(myval<iter_y){
