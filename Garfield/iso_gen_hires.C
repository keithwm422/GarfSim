...
int main(int argc, char * argv[]) {
  ...
  const double max_y_i=zone_y_max, max_x_i=max_x_in, stepy=0.05,stepx=0.1, min_y_i=zone_y_min;
  ...
  outrootfilename << "hires_isochrone_study/" << zone_in << "/isochron_distr_" << x_i << "_" << max_x_i << "_" << step_size << "_" << temperature << "_" << zone_in << "_.root";
