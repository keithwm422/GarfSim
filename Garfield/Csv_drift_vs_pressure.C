...
int main(int argc, char * argv[]) {
  ...
  while(gasfile_i<12){
    ...
    {
    case 0:
      gas->LoadGasFile("Gascomp_90_10_P_620.579_T_293.15_.gas"); // 12 psi
      mypressure[gasfile_i]=620.579;
      break;
    case 1:
      gas->LoadGasFile("Gascomp_90_10_P_646.436_T_293.15_.gas"); // 12.5
      mypressure[gasfile_i]=646.436;
      break;
    case 2:
      gas->LoadGasFile("Gascomp_90_10_P_672.294_T_293.15_.gas"); // 13
      mypressure[gasfile_i]=672.294;
      break;
    case 3:
      gas->LoadGasFile("Gascomp_90_10_P_698.151_T_293.15_.gas"); // 13.5
      mypressure[gasfile_i]=698.151;
      break;
    case 4:
    ...
    case 6:
      ...
      break;
    case 7:
      gas->LoadGasFile("Gascomp_90_10_P_801.581_T_293.15_.gas"); // 15.5
      mypressure[gasfile_i]=801.581;
      break;
    case 8:
      gas->LoadGasFile("Gascomp_90_10_P_827.438_T_293.15_.gas"); // 16
      mypressure[gasfile_i]=827.438;
      break;
    case 9:
      gas->LoadGasFile("Gascomp_90_10_P_853.296_T_293.15_.gas"); // 16.5
      mypressure[gasfile_i]=853.296;
      break;
    case 10:
      gas->LoadGasFile("Gascomp_90_10_P_879.153_T_293.15_.gas"); // 17
      mypressure[gasfile_i]=879.153;
      break;
    case 11:
      gas->LoadGasFile("Gascomp_90_10_P_905.011_T_293.15_.gas"); // 17.5
      mypressure[gasfile_i]=905.011;
      break;
    case 12:
      gas->LoadGasFile("Gascomp_90_10_P_930.868_T_293.15_.gas"); // 18
      mypressure[gasfile_i]=930.868;
      break;
    }
    //gas->PrintGas();
