...
//  const double pressure = 1 * AtmosphericPressure; // in torr- we were at 14.6 psi (1 psi = 51.7149 torr)
  ...
  ingasfilename << "/home/kmcbride/garfield/GarfSim/Garfield/Flight2024_midway_Boff_P_755.865_T_293.15_multiE_90CO2_10Ar_01232024_v2.gas";
...
//  gas->LoadGasFile("Flight2024_Bon_P_755.865_T_298.15_.gas");
  ...
  //outfilename << "Flight2024_Boff_P_" << pressure <<"_T_" << temperature << "_.gas";
  outputfilename << "isochronGenerator_p_fullEfield_T" << temperature << "_v2.txt";
  ...
  TFile * Outfile = new TFile("isochron_distr_v2.root","recreate");
  int pid = getpid();
  timeval t;
  gettimeofday(&t, NULL);
