...
//  gas->LoadGasFile("Flight2024_Bon_P_755.865_T_298.15_.gas");
  ...
  const double max_y_i=zone_y_max, max_x_i=max_x_in, stepy=0.2,stepx=0.5, min_y_i=zone_y_min;
  ...
  outputfilename << "temperature_isochrone_study/" << zone_in << "/isochrones_xmin_" << x_i << "_xmax" << max_x_i << "_stepsize_"<< step_size << "_temperature_" << zone_in << "_.txt";
  ...
  outrootfilename << "temperature_isochrone_study/" << zone_in << "/isochron_distr_" << x_i << "_" << max_x_i << "_" << step_size << "_" << temperature << "_" << zone_in << "_.root";
