...
//  gas->LoadGasFile("Flight2024_Bon_P_755.865_T_298.15_.gas");
  ...
  const double max_y_i=28.8, max_x_i=max_x_in, stepy=0.2,stepx=0.5, min_y_i=13.0;
  ...
  outputfilename << "flight_study_topq/isochronGenerator_multi_histo_xmin_" << x_i << "_xmax" << max_x_i << "_stepsize_"<< step_size << "_.txt";
  ...
  outrootfilename << "flight_study_topq/isochron_distr_" << x_i << "_" << max_x_i << "_" << step_size << "_.root";
