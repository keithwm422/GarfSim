...
int main(int argc, char * argv[]) {
  ...
  std::ofstream outputfile("isochron_BOFF_T303_p_full.txt",std::ios_base::app);
...
//  gas->LoadGasFile("Flight2024_Bon_P_755.865_T_303.15_.gas");
  gas->LoadGasFile("Flight2024_Boff_P_755.865_T_303.15_.gas");
...
//    for(int iw=0;iw<68;iw++){
  ...
  for(int ix=0;ix<size_of_x_grid;ix++){
    ...
    outputfile.open("isochron_BOFF_T303_p_full.txt",std::ios_base::app);
    while(myval<iter_y){
